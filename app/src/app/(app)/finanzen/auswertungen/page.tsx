...
import { Receipt, Send, AlertCircle, FileCheck2, Percent, ListFilter, TrendingUp, ChevronLeft } from "lucide-react";
...
export default async function FinanzenPage() {
  ...
  return (
    <>
      <div className="mb-2">
        <Link href="/finanzen" className="text-xs text-smoke hover:text-ink flex items-center gap-1">
          <ChevronLeft size={12} /> Zurück zu Rechnungen
        </Link>
      </div>
      <PageHeader
        eyebrow="Finanzen"
        title="Auswertungen"
        subtitle="Umsatz pro Monat, Status-Verteilung und Top-Pakete deines Jahres."
      />
